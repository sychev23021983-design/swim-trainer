...
const EMPTY = {
  title:'', category:'butterfly', sub_category:'kick', difficulty:1,
  sets:3, reps:10, duration_sec:'', rest_sec:45, reward_usd:0.25,
  input_type:'reps', muscles_primary:[], muscles_secondary:[],
  muscles_stabilizer:[], swim_benefit:'', instructions:'', tips:'', active:true
}
...
export default function Exercises() {
  ...
  const openEdit = ex => {
    setForm({ ...ex,
      ...
      muscles_stabilizer: ex.muscles_stabilizer || [],
    })
    setModal('edit')
  }
          ...
          <div style={{ background:'#fff', borderRadius:16, padding:'1.5rem', width:'100%', maxWidth:560,
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:12 }}>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'repeat(4,1fr)', gap:10 }}>
                ...
                <div><label style={{ fontSize:12, color:'var(--muted)', display:'block', marginBottom:4 }}>Сек (время)</label>{inp('duration_sec','number')}</div>
              ...
              <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:10 }}>
                ...
                <div>
                  ...
                  <select value={form.input_type} onChange={e => f('input_type', e.target.value)}
                    ...
                    <option value="reps">Кол-во</option>
                    <option value="time_sec">Время</option>
                  </select>
                </div>
              ...
              <div>
                <label style={{ fontSize:12, color:'var(--muted)', display:'block', marginBottom:4 }}>Инструкция</label>
              ...
              <div>
                <label style={{ fontSize:12, color:'var(--muted)', display:'block', marginBottom:4 }}>Советы</label>
                <textarea value={form.tips} onChange={e => f('tips', e.target.value)} rows={2}
                  style={{ width:'100%', padding:'8px 10px', border:'1px solid var(--border)', borderRadius:7, fontSize:13, resize:'vertical' }} />
              </div>
              <div>
                <label style={{ fontSize:12, color:'var(--muted)', display:'block', marginBottom:4 }}>Основные мышцы (через запятую)</label>
              ...
              <div>
                <label style={{ fontSize:12, color:'var(--muted)', display:'block', marginBottom:4 }}>Вспомогательные мышцы</label>
